...
class BASICCODEPROJECT_API USHealthComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(Replicated,BlueprintReadOnly, Category = "HealtComponent")
	float Health;

	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category = "HealtComponent")
	float DefaultHealth;
